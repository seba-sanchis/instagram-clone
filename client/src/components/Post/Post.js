  ...
  return (
    <article className="post">
      ...
      <button className="post-menu-btn" onClick={() => setToggleMenu(true)}>
        <svg className="post-menu-icon" role="img" viewBox="0 0 24 24">
      ...
      <section className="post-btns">
        ...
        >
          <svg
            ...
            role="img"
            viewBox={
              likes.find((like) => like === userId) ? "0 0 48 48" : "0 0 24 24"
            }
          >
            <path
              d={
        ...
        <button className="post-comment-btn" onClick={() => {}}>
          <svg className="post-comment-icon" role="img" viewBox="0 0 24 24">
            <path d="M20.656 17.008a9.993 9.993 0 10-3.59 3.615L22 22z"></path>
          </svg>
        </button>
      ...
      <div className="post-comments-container">
        ...
        <button className="post-comments-display" onClick={() => {}}>
          View all {comments.length} comments
        </button>
        <div>
          <div className="post-message">
            <span className="post-user">
              {comments[comments.length - 2]?.split(": ")[0]}
            </span>
            <span className="post-message">
              {comments[comments.length - 2]?.split(":")[1]}
            </span>
          </div>
          <div className="post-message">
            <span className="post-user">
              {comments[comments.length - 1]?.split(": ")[0]}
            </span>
            <span className="post-message">
              {comments[comments.length - 1]?.split(":")[1]}
            </span>
          </div>
        </div>
      </div>
      ...
      <section className="post-comment-add">
        <div className="post-emoji-container">
          <button className="post-emoji-btn">
            <svg className="post-emoji-icon" role="img" viewBox="0 0 24 24">
        ...
        <textarea
          ...
          onKeyPress={(event) =>
            event.key === "Enter" && comment ? handleComment() : null
          }
        />
        <button
