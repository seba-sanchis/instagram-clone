...
const Post = ({ post, setCurrentId }) => {
  ...
  return (
    <article className="post">
      ...
      <section>
        <textarea type="text" name="comment" value={comment} placeholder="Add a comment..." onChange={(e) => setComment(e.target.value) } />
        <button disabled={!comment} onClick={handleComment}>Post</button>
      </section>
    </article>
  );
};
